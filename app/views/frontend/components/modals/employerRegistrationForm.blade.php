<div class="modal modal-md fade" id="employerRegistrationForm" aria-labelledby="employerRegistrationForm" tabindex="-1" aria-hidden="true"
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" method="post" action="/register">
                        <input type="hidden" value="1" name="employer">
